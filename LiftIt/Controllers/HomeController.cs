...
using LiftIt.Models.AccountViewModels;
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Zły adres email/hasło lub brak potwierdzenia konta");
                    return View(model);
                }
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email, "Potwierdz swoje konto",
                      $"Proszę potwierdź swoje konto w aplikacji Lift-It klikając podany link: <a href='{callbackUrl}'>Potwierdź</a>");
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Reset hasła",
                   $"Proszę zresetować swoje hasło klikając w odnośnik:<a href='{callbackUrl}'>Resetuj</a>");
                return RedirectToAction(nameof(ForgotPasswordConfirmation));
            }
